<div>
    <h3 class="text-base font-semibold leading-6 text-gray-900">{{ $usage->title() }}</h3>
    <dl class="my-5 grid grid-cols-1 divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow md:grid-cols-2 md:divide-x md:divide-y-0">

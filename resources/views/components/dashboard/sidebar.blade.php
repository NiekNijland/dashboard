    ...
    <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
        <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            ...
            <nav class="mt-5 flex-1 space-y-1 px-2">
                ...
                <x-dashboard.sidebar.sidebar-link
                    route-name="torrents"
                    icon='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="m9 13.5 3 3m0 0 3-3m-3 3v-6m1.06-4.19-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" /></svg>'
                    text="{{ __('torrents.torrents') }}"
                />
                <x-dashboard.sidebar.sidebar-link
                    route-name="profile"
        ...
        <div class="flex justify-between w-full flex-shrink-0 bg-gray-700 p-4">
            ...
            <a href="{{ route('logout') }}" class="text-gray-300 bg-gray-800 hover:bg-gray-600 hover:text-white group flex items-center py-2 text-sm font-medium rounded-md px-2">
                <svg class="text-gray-400 group-hover:text-gray-300 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
